        ...
        <Box borderRadius='10px' padding='20px' bgcolor='#11182a' position='absolute' height='40%' width='40%' top='30%' left='30%'>
          <Stack direction='column'>
            <Grid style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginBottom: '50px' }} item xs={12}>
              <Typography variant='h5' style={{ textAlign: 'center', marginRight: '10px' }} color='azure'>Export Tileset</Typography>
            </Grid>

            <Grid style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginBottom: '10px' }} item xs={12}>
              <Typography style={{ fontSize: '14px', textAlign: 'center', marginRight: '10px' }} color='azure'>Tileset Name: {store.currentProject.title}</Typography>
            </Grid>

            <Grid style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', marginBottom: '10px' }} item xs={12}>
              <Typography style={{ fontSize: '14px', textAlign: 'center', marginRight: '10px' }} color='azure'>Num Tiles: {store.currentProject.tiles.length}</Typography>
            </Grid>
